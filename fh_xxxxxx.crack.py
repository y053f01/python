...
""")
    ...
    if mac_address[:8] != '6C:A5:D1':
        print(f"""\n{colors.CYELLOW2}Can't generate the password, it's not fh_xxxxxx FiberHome modem :( """)
    else:
        # Generate the SSID
        ...
        print(f"""
{colors.CWHITE2}SSID: {ssid.lower()}
...
{colors.CVIOLET2}Enjoy Free Net ;) and be the Admin :)
""")
